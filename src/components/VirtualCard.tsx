...
export default function VirtualCard({ card }: Props) {
  return (
    <div className="relative aspect-[1.586/1] w-full max-w-sm overflow-hidden rounded-xl bg-slatedark p-5 text-white shadow-lg">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="rounded bg-ochre/90 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-[#0C0D17]">
          ficticia
        </span>
      </div>
      ...
      <div className="mt-6 flex items-end justify-between text-xs">
        <div>
          <div className="text-white/50 uppercase tracking-wide text-[10px]">Titular</div>
          <div className="figure">{card.holderName}</div>
        </div>
        <div>
          <div className="text-white/50 uppercase tracking-wide text-[10px]">Vence</div>
